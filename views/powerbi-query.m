let
    ...
    #"Expanded Tags" = Table.ExpandRecordColumn(#"Parsed JSON Tags", "Tags", {"environment"}, {"Tags.Environment"}),
    #"Trimmed Text" = Table.TransformColumns(#"Expanded Tags",{{"Tags.Environment", Text.Trim, type text}}),
    #"Parsed JSON AdditionalInfo" = Table.TransformColumns(#"Trimmed Text",{{"AdditionalInfo", Json.Document}}),
    #"Expanded AdditionalInfo" = Table.ExpandRecordColumn(#"Parsed JSON AdditionalInfo", "AdditionalInfo", {"BelowNetworkThreshold", "SupportsDataDisksCount", "MetricIOPS", "SupportsIOPS", "BelowMemoryThreshold", "currentSku", "targetSku", "SupportsNICCount", "DataDiskCount", "MetricMemoryPercentage", "MetricNetworkMbps", "MetricMiBps", "SupportsMiBps", "BelowCPUThreshold", "NicCount", "MetricCPUPercentage", "annualSavingsAmount", "savingsCurrency", "savingsAmount", "CostsAmount", "reservationType", "vmSize", "DiskType", "DiskSizeGB", "MaxMemoryP95", "MaxCpuP95", "MaxTotalNetworkP95", "DeploymentModel"}, {"AddInfo.BelowNetworkThreshold", "AddInfo.SupportsDataDisksCount", "AddInfo.MetricIOPS", "AddInfo.SupportsIOPS", "AddInfo.BelowMemoryThreshold", "AddInfo.currentSku", "AddInfo.targetSku", "AddInfo.SupportsNICCount", "AddInfo.DataDiskCount", "AddInfo.MetricMemoryPercentage", "AddInfo.MetricNetworkMbps", "AddInfo.MetricMiBps", "AddInfo.SupportsMiBps", "AddInfo.BelowCPUThreshold", "AddInfo.NicCount", "AddInfo.MetricCPUPercentage", "AddInfo.annualSavingsAmount", "AddInfo.savingsCurrency", "AddInfo.savingsAmount", "AddInfo.CostsAmount", "AddInfo.reservationType", "AddInfo.vmSize", "AddInfo.DiskType", "AddInfo.DiskSizeGB", "AddInfo.MaxMemoryP95", "AddInfo.MaxCpuP95", "AddInfo.MaxTotalNetworkP95", "AddInfo.DeploymentModel"}),
