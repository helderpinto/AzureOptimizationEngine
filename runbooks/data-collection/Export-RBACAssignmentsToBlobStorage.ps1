...
$subscriptions = Get-AzSubscription -TenantId $tenantId | Where-Object { $_.State -eq "Enabled" -and ($_.ExtendedProperties['SubscriptionPolices'] | ConvertFrom-Json).quotaId -ne "AAD_2015-09-01" }
